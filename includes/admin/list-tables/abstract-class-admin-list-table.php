<?php
/**
 * Plugin-specific admin list tables
 * 
...
abstract class Maxson_Portfolio_Projects_Admin_List_Table {
	...
	{ 
		...
		{ 
			...
			$styles .= '#posts-filter .wp-list-table, #posts-filter .tablenav.top, .tablenav.bottom .actions, .wrap .subsubsub { display: none;}';
			$styles .= '#posts-filter .tablenav.bottom { height: auto;}';
			$styles .= '</style>';
