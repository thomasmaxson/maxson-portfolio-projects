...
{ 
	class Maxson_Portfolio_Projects_Admin_Customize { 
		...
		//	$wp_customize->add_setting( 'maxson_portfolio_setup_callout array( 
			//	'transport'  => 'refresh', 
		//		'type'       => 'option', 
		//		'default'    => true, 
		//		'capability' => 'edit_theme_options', 
		...
		//	$wp_customize->add_control( 'maxson_portfolio_customizer_activate_callout', array( 
		//		'section'  => "maxson_portfolio_{$section}", 
		//		'priority' => $section_priority, 
		//		'type'     => 'checkbox', 
		//		'label'    => __( 'Activate callout projects', 'maxson' ), 
		//		'settings' => 'maxson_portfolio_setup_callout'
		//	) );
