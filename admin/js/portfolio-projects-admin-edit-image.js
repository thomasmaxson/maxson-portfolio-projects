...
var MaxsonPortfolioSlide = Backbone.Model.extend({ 
...
* - Each image is represented by an MaxsonPortfolioSlides Model
*/

var MaxsonPortfolioSlides = new Backbone.Collection;
...
var MaxsonPortfolioImageModalWindow = new wp.media.view.Modal({ 
	controller : { 
		trigger : function(){ }
	}
});
...
var MaxsonPortfolioImageView = wp.Backbone.View.extend({ 
...
;(function( $ ){ 
	$( document ).ready( function(){ 
		maxson_portfolio_edit = { 
			init: function(){ 
				// Populate the collection
			//	SoliloquySlidesUpdate();

				$( '#project-gallery-images' ).on( 'click', '.gallery-image', function( event ) { 
					...
					MaxsonPortfolioImageModalWindow.content( new MaxsonPortfolioImageView( {
						collection    : MaxsonPortfolioSlides,
						child_views   : MaxsonPortfolioChildViews,
						attachment_id : attachment_id,
					} ) );

					// Open the modal window
					MaxsonPortfolioImageModalWindow.open();
					
					$( document ).trigger( 'MaxsonPortfolioEditImageOpen' );
